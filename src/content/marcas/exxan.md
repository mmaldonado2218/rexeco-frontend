...
propuestaValor:
  ...
  - titulo: Clasificación técnica
    descripcion: Clasificación especializada para maximizar el valor de cada lote.
  - titulo: Pago transparente
    descripcion: Procesos claros y pagos puntuales. Sin sorpresas.
  - titulo: Capacidad para grandes volúmenes
    descripcion: Infraestructura para manejar operaciones industriales a escala.
queHacemos:
...
Exxan, empresa de Grupo Rexeco, se especializa en la compra, recepción y valorización de metales ferrosos, entregando soluciones eficientes para empresas e industrias que manejan grandes volúmenes.

Nuestro enfoque está en la rapidez operativa, seguridad y transparencia en el pago.
